    ...
    buyables:{
      11: {
            ...
            effect(x = getBuyableAmount(this.layer,this.id)) { 
              ...
              var eff = expRoot(player.points.add(10).slog(10).log10().add(1).mul(10),1.125).div(10).pow(x.add(1).cbrt())
              return eff },
            ...
            buymax(){
              ...
              var x = b.pow(2).sub(a.mul(c).mul(4)).sqrt().sub(b).div(a.mul(2)).floor()
        ...
        13: {
            ...
            effect(x = getBuyableAmount(this.layer,this.id)) { 
              x = x.add(this.extraLevel())
              var eff = player.mm.total.add(1).log10().add(player.overflow.total.add(1).log10()).div(10).add(1).pow(x.add(1).log10().add(1).pow(2).sub(1))
              return eff },
            canAfford() { return player[this.layer].points.gte(this.cost()) },
            title() {
                return "增量^"
