addLayer("dim", {
    ...
    effect(){
      var eff = expPow(player.dim.points.add(1).log10().div(5).pow(1.6).add(10),1.8).sub(9)
      return eff
    },
    effectDescription() {
        return `<br> 未使用的元元使得弦基础倍率^${format(this.mmeff())}.<br>
          倍率基于加速子,时间和元性质提高<br>
    ...
    challenges:{
      11:{
        ...
        rewardEffect(){return expRoot(getCP(this.layer,11).div(1e128).add(1).root(25),1.25)},
        goal:n(1e128),
